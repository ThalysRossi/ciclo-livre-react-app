  ...
  return (
    <>
      <div className="flex flex-col text-center items-center px-10 pb-16">
        ...
        <p
          className={`text-[#0C0C0C] text-xs pt-8 font-normal transition-opacity ease-in duration-700 ${
        ...
        <img
          src={feet}
          className={`pt-16 transition-opacity ease-in duration-700 ${
            isVisibleImage1 ? "opacity-100" : "opacity-0"
          }`}
          ref={refImage1}
        ></img>
        <h1
          className={`text-clRed text-3xl font-semibold pt-16 transition-opacity ease-in duration-700 ${
        ...
        <ul
          className={`text-left list-item list-disc pt-5 pb-10 transition-opacity ease-in duration-700 ${
